...
class MTNMobileMoneyPaiementMethod {
    ...
    buy(transaction, buyer, paiementMethod) {
        ...
        return this.paiementMethodeStrategyService.buy(this.configService.getValueOf("paiement").mtnPaiementUrl, {
    ...
    check(financialTransaction, buyer, paiementMethod) {
        return this.paiementMethodeStrategyService.check(this.configService.getValueOf("paiement").mtnCheckPaiementUrl, {
...
], MTNMobileMoneyPaiementMethod.prototype, "configService", void 0);
exports.MTNMobileMoneyPaiementMethod = MTNMobileMoneyPaiementMethod;
