...
class TransportServiceType extends KarryngoPersistentEntity_1.KarryngoPersistentEntity {
    ...
    toString() {
        return Object.assign(Object.assign({}, super.toString()), { address: {
                ...
                images: this.images,
            }, title: this.title, suggestedPrice: this.suggestedPrice, state: this.state, idRequester: this.idRequester, idSelectedProvider: this.idSelectedProvider, idSelectedTransaction: this.idSelectedTransaction, providers: this.providers, transactions: this.transactions.map((trans) => trans.toString()), bill: this.bill });
