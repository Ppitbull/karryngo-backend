...
let ServiceManager = class ServiceManager {
    constructor(transportServiceManager, chatService, rateService, emailService, userHistoryService
    ...
    getRateByCountry(request, response) {
